 ...
 * number. Based on code from:
 * http://www.javaspecialists.co.za/archive/Issue092.html
 */
public class MemoryWarningSystem {

	static MemoryWarningSystem singleton = new MemoryWarningSystem();
	...
	private MemoryWarningSystem() {
		...
		System.out.println("MemoryWarningSystem started");
		emitter.addNotificationListener(new NotificationListener() {
			...
			public void handleNotification(Notification n, Object hb) {
				if (n.getType().equals(
					...
					System.out.println("MemoryWarningSystem maxMemory "
							+ maxMemory + " usedMemory : " + usedMemory);
	...
	public static MemoryWarningSystem getMemoryWarnSystem() {
		return singleton;
	}
