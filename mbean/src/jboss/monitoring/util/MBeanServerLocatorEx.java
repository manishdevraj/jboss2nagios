...
/**
 * This class can act as replacement for MBeanServerLocator.locateJBoss() which
 * was compatible to older Jboss version
 * 
...
public class MBeanServerLocatorEx {
	...
	public static MBeanServer locateJBoss() throws Exception {
		for (MBeanServer server : javax.management.MBeanServerFactory
